	...
	return (
		<S.Wrapper>
			...
			<S.StepsGrid>
				...
				>
					Em seguida, partimos para a análise do local e do contexto em torno da
					demanda. Este é o momento de relacionar as necessidades e expectativas
					com o contexto circundante, estabelecendo também conexão com o tempo
					presente.
				</CreativeStep>
				<CreativeStep
					stepNumber={3}
				...
				>
					...
					deste processo obtemos um projeto coerente e assertivo, compatível com
					os objetivos e capaz de concretizar novas ideias.
				</CreativeStep>
			</S.StepsGrid>
		</S.Wrapper>
	)
